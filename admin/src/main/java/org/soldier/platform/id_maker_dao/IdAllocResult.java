...
public class IdAllocResult implements org.apache.thrift.TBase<IdAllocResult, IdAllocResult._Fields>, java.io.Serializable, Cloneable, Comparable<IdAllocResult> {
  ...
  private static class IdAllocResultStandardScheme extends StandardScheme<IdAllocResult> {
    ...
    public void read(org.apache.thrift.protocol.TProtocol iprot, IdAllocResult struct) throws org.apache.thrift.TException {
      ...
      if (!struct.isSetBeginId()) {
        throw new org.apache.thrift.protocol.TProtocolException("Required field 'beginId' was not found in serialized data! Struct: " + toString());
      }
      if (!struct.isSetAllocSize()) {
        throw new org.apache.thrift.protocol.TProtocolException("Required field 'allocSize' was not found in serialized data! Struct: " + toString());
      }
      struct.validate();
    }

    public void write(org.apache.thrift.protocol.TProtocol oprot, IdAllocResult struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class IdAllocResultTupleScheme extends TupleScheme<IdAllocResult> {
    ...
    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, IdAllocResult struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, IdAllocResult struct) throws org.apache.thrift.TException {
