...
public class MsgQConsumer implements org.apache.thrift.TBase<MsgQConsumer, MsgQConsumer._Fields>, java.io.Serializable, Cloneable, Comparable<MsgQConsumer> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("MsgQConsumer");
  ...
  private static final org.apache.thrift.protocol.TField CONSUMER_PROPERTIES_FIELD_DESC = new org.apache.thrift.protocol.TField("consumerProperties", org.apache.thrift.protocol.TType.MAP, (short)4);
  ...
  static {
    schemes.put(StandardScheme.class, new MsgQConsumerStandardSchemeFactory());
    schemes.put(TupleScheme.class, new MsgQConsumerTupleSchemeFactory());
  }
  ...
  public Map<String,String> consumerProperties; // optional
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
     ...
     */
    MODE((short)3, "mode"),
    CONSUMER_PROPERTIES((short)4, "consumerProperties"),
  ...
  private _Fields optionals[] = {_Fields.CONSUMER_KEY,_Fields.TOPIC_NAME,_Fields.MODE,_Fields.CONSUMER_PROPERTIES,_Fields.CONSUMER_DESC,_Fields.HAS_SYNC,_Fields.CREATE_TIMESTAMP,_Fields.LASTMODIFY_TIMESTAMP};
  ...
  static {
    ...
    tmpMap.put(_Fields.CONSUMER_PROPERTIES, new org.apache.thrift.meta_data.FieldMetaData("consumerProperties", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(MsgQConsumer.class, metaDataMap);
  }
   ...
   */
  public MsgQConsumer(MsgQConsumer other) {
    ...
    if (other.isSetConsumerProperties()) {
      Map<String,String> __this__consumerProperties = new HashMap<String,String>(other.consumerProperties);
      this.consumerProperties = __this__consumerProperties;
    }
  ...
  public MsgQConsumer deepCopy() {
    return new MsgQConsumer(this);
  }
  ...
  public MsgQConsumer setConsumerKey(String consumerKey) {
  ...
  public MsgQConsumer setTopicName(String topicName) {
   ...
   * @see ConsumerMode
   */
  public MsgQConsumer setMode(ConsumerMode mode) {
    this.mode = mode;
    return this;
  }
  ...
  public int getConsumerPropertiesSize() {
    return (this.consumerProperties == null) ? 0 : this.consumerProperties.size();
  }

  public void putToConsumerProperties(String key, String val) {
  ...
  public MsgQConsumer setConsumerProperties(Map<String,String> consumerProperties) {
    this.consumerProperties = consumerProperties;
    return this;
  }

  public void unsetConsumerProperties() {
    this.consumerProperties = null;
  }

  /** Returns true if field consumerProperties is set (has been assigned a value) and false otherwise */
  public boolean isSetConsumerProperties() {
    return this.consumerProperties != null;
  }

  public void setConsumerPropertiesIsSet(boolean value) {
    if (!value) {
      this.consumerProperties = null;
    }
  }
  ...
  public MsgQConsumer setConsumerDesc(String consumerDesc) {
  ...
  public MsgQConsumer setHasSync(short hasSync) {
  ...
  public MsgQConsumer setCreateTimestamp(int createTimestamp) {
  ...
  public MsgQConsumer setLastmodifyTimestamp(int lastmodifyTimestamp) {
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case CONSUMER_PROPERTIES:
      if (value == null) {
        unsetConsumerProperties();
      } else {
        setConsumerProperties((Map<String,String>)value);
      }
      break;
  ...
  public boolean isSet(_Fields field) {
    ...
    case MODE:
      return isSetMode();
    case CONSUMER_PROPERTIES:
      return isSetConsumerProperties();
    case CONSUMER_DESC:
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof MsgQConsumer)
      return this.equals((MsgQConsumer)that);
    return false;
  }

  public boolean equals(MsgQConsumer that) {
    if (that == null)
      return false;
    ...
    boolean this_present_consumerProperties = true && this.isSetConsumerProperties();
    boolean that_present_consumerProperties = true && that.isSetConsumerProperties();
    if (this_present_consumerProperties || that_present_consumerProperties) {
      if (!(this_present_consumerProperties && that_present_consumerProperties))
        return false;
      if (!this.consumerProperties.equals(that.consumerProperties))
        return false;
    }
  ...
  @Override
  public int compareTo(MsgQConsumer other) {
    ...
    lastComparison = Boolean.valueOf(isSetConsumerProperties()).compareTo(other.isSetConsumerProperties());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetConsumerProperties()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.consumerProperties, other.consumerProperties);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("MsgQConsumer(");
    boolean first = true;
    ...
    if (isSetConsumerProperties()) {
      ...
      if (this.consumerProperties == null) {
        ...
        sb.append(this.consumerProperties);
      }
      first = false;
    }
    if (isSetConsumerDesc()) {
  ...
  private static class MsgQConsumerStandardSchemeFactory implements SchemeFactory {
    public MsgQConsumerStandardScheme getScheme() {
      return new MsgQConsumerStandardScheme();
    }
  }

  private static class MsgQConsumerStandardScheme extends StandardScheme<MsgQConsumer> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, MsgQConsumer struct) throws org.apache.thrift.TException {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.consumerProperties = new HashMap<String,String>(2*_map50.size);
                for (int _i51 = 0; _i51 < _map50.size; ++_i51)
                {
                  ...
                  struct.consumerProperties.put(_key52, _val53);
                }
                iprot.readMapEnd();
              }
              struct.setConsumerPropertiesIsSet(true);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, MsgQConsumer struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.consumerProperties != null) {
        if (struct.isSetConsumerProperties()) {
          oprot.writeFieldBegin(CONSUMER_PROPERTIES_FIELD_DESC);
          {
            oprot.writeMapBegin(new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.STRING, org.apache.thrift.protocol.TType.STRING, struct.consumerProperties.size()));
            for (Map.Entry<String, String> _iter54 : struct.consumerProperties.entrySet())
            {
  ...
  private static class MsgQConsumerTupleSchemeFactory implements SchemeFactory {
    public MsgQConsumerTupleScheme getScheme() {
      return new MsgQConsumerTupleScheme();
    }
  }

  private static class MsgQConsumerTupleScheme extends TupleScheme<MsgQConsumer> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, MsgQConsumer struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetConsumerProperties()) {
        {
          oprot.writeI32(struct.consumerProperties.size());
          for (Map.Entry<String, String> _iter55 : struct.consumerProperties.entrySet())
          {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, MsgQConsumer struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(3)) {
        {
          ...
          struct.consumerProperties = new HashMap<String,String>(2*_map56.size);
          for (int _i57 = 0; _i57 < _map56.size; ++_i57)
          {
            ...
            struct.consumerProperties.put(_key58, _val59);
          }
        }
        struct.setConsumerPropertiesIsSet(true);
      }
