            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.resultList = new ArrayList<StorageInfo>(_list8.size);
                for (int _i9 = 0; _i9 < _list8.size; ++_i9)
                {
                  StorageInfo _elem10;
                  _elem10 = new StorageInfo();
                  _elem10.read(iprot);
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, StorageInfoList struct) throws org.apache.thrift.TException {
      ...
      if (struct.resultList != null) {
        oprot.writeFieldBegin(RESULT_LIST_FIELD_DESC);
        {
          ...
          for (StorageInfo _iter11 : struct.resultList)
          {
            _iter11.write(oprot);
          }
          oprot.writeListEnd();
      ...
      if (struct.isSetResultList()) {
        {
          ...
          for (StorageInfo _iter12 : struct.resultList)
          {
            _iter12.write(oprot);
          }
        }
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.resultList = new ArrayList<StorageInfo>(_list13.size);
          for (int _i14 = 0; _i14 < _list13.size; ++_i14)
          {
            StorageInfo _elem15;
            _elem15 = new StorageInfo();
            _elem15.read(iprot);
