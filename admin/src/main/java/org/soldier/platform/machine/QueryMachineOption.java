            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.hostNames = new ArrayList<String>(_list56.size);
                for (int _i57 = 0; _i57 < _list56.size; ++_i57)
                {
                  String _elem58;
                  _elem58 = iprot.readString();
                  struct.hostNames.add(_elem58);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.hostInnerIPS = new ArrayList<String>(_list59.size);
                for (int _i60 = 0; _i60 < _list59.size; ++_i60)
                {
                  String _elem61;
                  _elem61 = iprot.readString();
                  struct.hostInnerIPS.add(_elem61);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.hostNames != null) {
        if (struct.isSetHostNames()) {
          oprot.writeFieldBegin(HOST_NAMES_FIELD_DESC);
          {
            ...
            for (String _iter62 : struct.hostNames)
            {
      ...
      if (struct.hostInnerIPS != null) {
        if (struct.isSetHostInnerIPS()) {
          oprot.writeFieldBegin(HOST_INNER_IPS_FIELD_DESC);
          {
            ...
            for (String _iter63 : struct.hostInnerIPS)
            {
      ...
      if (struct.isSetHostNames()) {
        {
          ...
          for (String _iter64 : struct.hostNames)
          {
      ...
      if (struct.isSetHostInnerIPS()) {
        {
          ...
          for (String _iter65 : struct.hostInnerIPS)
          {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.hostNames = new ArrayList<String>(_list66.size);
          for (int _i67 = 0; _i67 < _list66.size; ++_i67)
          {
            String _elem68;
            _elem68 = iprot.readString();
            struct.hostNames.add(_elem68);
          }
        }
        struct.setHostNamesIsSet(true);
      }
      if (incoming.get(1)) {
        {
          ...
          struct.hostInnerIPS = new ArrayList<String>(_list69.size);
          for (int _i70 = 0; _i70 < _list69.size; ++_i70)
          {
            String _elem71;
            _elem71 = iprot.readString();
            struct.hostInnerIPS.add(_elem71);
          }
        }
        struct.setHostInnerIPSIsSet(true);
      }
