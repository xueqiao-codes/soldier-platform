...
public class ProtocolUtil {
	...
	public static < T extends TBase> byte[] serialize2Bytes(TProtocolFactory protocolFactory, T instance) {
		ByteBuffer dataBuffer = serialize(protocolFactory, instance);
		if (dataBuffer == null) {
			return null;
		}
