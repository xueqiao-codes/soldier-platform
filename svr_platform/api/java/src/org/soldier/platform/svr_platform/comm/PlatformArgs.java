...
public class PlatformArgs implements org.apache.thrift.TBase<PlatformArgs, PlatformArgs._Fields>, java.io.Serializable, Cloneable, Comparable<PlatformArgs> {
  ...
  private static final org.apache.thrift.protocol.TField EXTRA_PARAMS_FIELD_DESC = new org.apache.thrift.protocol.TField("extraParams", org.apache.thrift.protocol.TType.MAP, (short)9);
  ...
  public Map<String,String> extraParams; // optional
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    ...
    EXTRA_PARAMS((short)9, "extraParams");
  ...
  private _Fields optionals[] = {_Fields.SOURCE_DESC,_Fields.SOURCE_IP_V4,_Fields.REMOTE_ADDRESS,_Fields.REMOTE_PORT,_Fields.X_FORWARD_ADDRESS,_Fields.SOURCE_IP,_Fields.TIMEOUT_MS,_Fields.CLIENT_LANG,_Fields.EXTRA_PARAMS};
  ...
  static {
    ...
    tmpMap.put(_Fields.EXTRA_PARAMS, new org.apache.thrift.meta_data.FieldMetaData("extraParams", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
  ...
  public PlatformArgs(PlatformArgs other) {
    ...
    if (other.isSetExtraParams()) {
      Map<String,String> __this__extraParams = new HashMap<String,String>(other.extraParams);
  ...
  public void putToExtraParams(String key, String val) {
  ...
  public PlatformArgs setExtraParams(Map<String,String> extraParams) {
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case EXTRA_PARAMS:
      if (value == null) {
        ...
        setExtraParams((Map<String,String>)value);
      }
      break;
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.extraParams = new HashMap<String,String>(2*_map10.size);
                for (int _i11 = 0; _i11 < _map10.size; ++_i11)
                {
                  ...
                  struct.extraParams.put(_key12, _val13);
                }
                iprot.readMapEnd();
              }
      ...
      if (struct.extraParams != null) {
        if (struct.isSetExtraParams()) {
          oprot.writeFieldBegin(EXTRA_PARAMS_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, String> _iter14 : struct.extraParams.entrySet())
            {
      ...
      if (struct.isSetExtraParams()) {
        {
          ...
          for (Map.Entry<String, String> _iter15 : struct.extraParams.entrySet())
          {
      ...
      if (incoming.get(8)) {
        {
          ...
          struct.extraParams = new HashMap<String,String>(2*_map16.size);
          for (int _i17 = 0; _i17 < _map16.size; ++_i17)
          {
            ...
            struct.extraParams.put(_key18, _val19);
          }
        }
        struct.setExtraParamsIsSet(true);
      }
