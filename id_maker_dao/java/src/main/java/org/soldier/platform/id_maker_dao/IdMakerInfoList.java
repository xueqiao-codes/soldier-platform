            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.resultList = new ArrayList<IdMakerInfo>(_list0.size);
                for (int _i1 = 0; _i1 < _list0.size; ++_i1)
                {
                  IdMakerInfo _elem2;
                  _elem2 = new IdMakerInfo();
                  _elem2.read(iprot);
      ...
      if (struct.resultList != null) {
        if (struct.isSetResultList()) {
          oprot.writeFieldBegin(RESULT_LIST_FIELD_DESC);
          {
            ...
            for (IdMakerInfo _iter3 : struct.resultList)
            {
              _iter3.write(oprot);
            }
            oprot.writeListEnd();
      ...
      if (struct.isSetResultList()) {
        {
          ...
          for (IdMakerInfo _iter4 : struct.resultList)
          {
            _iter4.write(oprot);
          }
        }
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.resultList = new ArrayList<IdMakerInfo>(_list5.size);
          for (int _i6 = 0; _i6 < _list5.size; ++_i6)
          {
            IdMakerInfo _elem7;
            _elem7 = new IdMakerInfo();
            _elem7.read(iprot);
