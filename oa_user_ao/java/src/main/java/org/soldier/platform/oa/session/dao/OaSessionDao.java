              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.success = new ArrayList<TSession>(_list8.size);
                  for (int _i9 = 0; _i9 < _list8.size; ++_i9)
                  {
                    TSession _elem10;
                    _elem10 = new TSession();
                    _elem10.read(iprot);
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, getSession_result struct) throws org.apache.thrift.TException {
        ...
        if (struct.success != null) {
          oprot.writeFieldBegin(SUCCESS_FIELD_DESC);
          {
            ...
            for (TSession _iter11 : struct.success)
            {
              _iter11.write(oprot);
            }
            oprot.writeListEnd();
        ...
        if (struct.isSetSuccess()) {
          {
            ...
            for (TSession _iter12 : struct.success)
            {
              _iter12.write(oprot);
            }
          }
        ...
        if (incoming.get(0)) {
          {
            ...
            struct.success = new ArrayList<TSession>(_list13.size);
            for (int _i14 = 0; _i14 < _list13.size; ++_i14)
            {
              TSession _elem15;
              _elem15 = new TSession();
              _elem15.read(iprot);
