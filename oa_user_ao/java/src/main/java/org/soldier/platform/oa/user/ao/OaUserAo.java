              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.success = new ArrayList<org.soldier.platform.oa.user.OaUser>(_list0.size);
                  for (int _i1 = 0; _i1 < _list0.size; ++_i1)
                  {
                    org.soldier.platform.oa.user.OaUser _elem2;
                    _elem2 = new org.soldier.platform.oa.user.OaUser();
                    _elem2.read(iprot);
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, queryUser_result struct) throws org.apache.thrift.TException {
        ...
        if (struct.success != null) {
          oprot.writeFieldBegin(SUCCESS_FIELD_DESC);
          {
            ...
            for (org.soldier.platform.oa.user.OaUser _iter3 : struct.success)
            {
              _iter3.write(oprot);
            }
            oprot.writeListEnd();
        ...
        if (struct.isSetSuccess()) {
          {
            ...
            for (org.soldier.platform.oa.user.OaUser _iter4 : struct.success)
            {
              _iter4.write(oprot);
            }
          }
        ...
        if (incoming.get(0)) {
          {
            ...
            struct.success = new ArrayList<org.soldier.platform.oa.user.OaUser>(_list5.size);
            for (int _i6 = 0; _i6 < _list5.size; ++_i6)
            {
              org.soldier.platform.oa.user.OaUser _elem7;
              _elem7 = new org.soldier.platform.oa.user.OaUser();
              _elem7.read(iprot);
