   ...
   */
   public class FrameBuffer {
    ...
    public void invoke() {
      ...
      boolean isNonblockingSocket = (trans_ instanceof TNonblockingSocket);
      try {
        if (eventHandler_ != null) {
        ...
        if (isNonblockingSocket) {
        	SocketAddressThreadLocal.getInstance().set(
        			(InetSocketAddress)(((TNonblockingSocket) trans_).getSocketChannel().getRemoteAddress()));
        }
        ...
        LOGGER.error("Unexpected throwable while invoking!", t);
    	  ...
    	  if (isNonblockingSocket) {
    		  SocketAddressThreadLocal.getInstance().set(null);
    	  }
      }
