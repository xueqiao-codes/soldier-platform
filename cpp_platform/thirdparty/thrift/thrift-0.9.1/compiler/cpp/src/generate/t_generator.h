...
//  virtual void generate_client_impl (t_service* tservice){}
//  virtual void generate_server_impl (t_service* tservice){}
//  virtual void generate_adaptor(t_service* tservice){ }
//  virtual void generate_async_client_impl(t_service* tservice){}
