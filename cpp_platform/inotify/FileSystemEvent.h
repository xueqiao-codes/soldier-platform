...
#ifndef INOTIFY_FILESYSTEMEVENT_INCLUDE_
#define INOTIFY_FILESYSTEMEVENT_INCLUDE_
...
inline FileSystemEvent::FileSystemEvent(const int wd, uint32_t mask,
        const boost::filesystem::path path) :
        isRecursive(false), wd(wd), mask(mask), path(path) {
...
#endif // INOTIFY_FILESYSTEMEVENT_INCLUDE_
