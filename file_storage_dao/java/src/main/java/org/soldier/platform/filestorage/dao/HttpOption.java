...
public class HttpOption implements org.apache.thrift.TBase<HttpOption, HttpOption._Fields>, java.io.Serializable, Cloneable, Comparable<HttpOption> {
  ...
  private _Fields optionals[] = {_Fields.CONTENT_TYPE,_Fields.EXPIRE_TIMESTAMP,_Fields.CONTENT_ENCODING,_Fields.CATCH_CONTROL,_Fields.CONTENT_DISPOSITION,_Fields.USER_META_DATA};
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.userMetaData = new HashMap<String,String>(2*_map0.size);
                for (int _i1 = 0; _i1 < _map0.size; ++_i1)
                {
                  ...
                  struct.userMetaData.put(_key2, _val3);
                }
                iprot.readMapEnd();
              }
      ...
      if (struct.userMetaData != null) {
        if (struct.isSetUserMetaData()) {
          oprot.writeFieldBegin(USER_META_DATA_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, String> _iter4 : struct.userMetaData.entrySet())
            {
      ...
      if (struct.isSetUserMetaData()) {
        {
          ...
          for (Map.Entry<String, String> _iter5 : struct.userMetaData.entrySet())
          {
      ...
      if (incoming.get(5)) {
        {
          ...
          struct.userMetaData = new HashMap<String,String>(2*_map6.size);
          for (int _i7 = 0; _i7 < _map6.size; ++_i7)
          {
            ...
            struct.userMetaData.put(_key8, _val9);
          }
        }
        struct.setUserMetaDataIsSet(true);
      }
