...
public class RouteInfoList implements org.apache.thrift.TBase<RouteInfoList, RouteInfoList._Fields>, java.io.Serializable, Cloneable, Comparable<RouteInfoList> {
  ...
  public List<RouteInfo> resultList; // optional
  ...
  public RouteInfoList(RouteInfoList other) {
    ...
    if (other.isSetResultList()) {
      List<RouteInfo> __this__resultList = new ArrayList<RouteInfo>(other.resultList.size());
      for (RouteInfo other_element : other.resultList) {
        __this__resultList.add(new RouteInfo(other_element));
      }
  ...
  public RouteInfoList setTotalCount(int totalCount) {
  ...
  public java.util.Iterator<RouteInfo> getResultListIterator() {
    return (this.resultList == null) ? null : this.resultList.iterator();
  }

  public void addToResultList(RouteInfo elem) {
    if (this.resultList == null) {
      this.resultList = new ArrayList<RouteInfo>();
    }
    this.resultList.add(elem);
  }

  public List<RouteInfo> getResultList() {
    return this.resultList;
  }

  public RouteInfoList setResultList(List<RouteInfo> resultList) {
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case RESULT_LIST:
      if (value == null) {
        ...
        setResultList((List<RouteInfo>)value);
      }
      break;
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.resultList = new ArrayList<RouteInfo>(_list40.size);
                for (int _i41 = 0; _i41 < _list40.size; ++_i41)
                {
                  RouteInfo _elem42;
                  _elem42 = new RouteInfo();
                  _elem42.read(iprot);
      ...
      if (struct.resultList != null) {
        if (struct.isSetResultList()) {
          oprot.writeFieldBegin(RESULT_LIST_FIELD_DESC);
          {
            ...
            for (RouteInfo _iter43 : struct.resultList)
            {
              _iter43.write(oprot);
            }
            oprot.writeListEnd();
      ...
      if (struct.isSetResultList()) {
        {
          ...
          for (RouteInfo _iter44 : struct.resultList)
          {
            _iter44.write(oprot);
          }
        }
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.resultList = new ArrayList<RouteInfo>(_list45.size);
          for (int _i46 = 0; _i46 < _list45.size; ++_i46)
          {
            RouteInfo _elem47;
            _elem47 = new RouteInfo();
            _elem47.read(iprot);
