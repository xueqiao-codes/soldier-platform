...
public class TradeHostingStorageAsyncStub extends BaseStub { 
  ...
  public long createExecOrderId(int routeKey, int timeout, IMethodCallback<TradeHostingStorage.createExecOrderId_args, TradeHostingStorage.createExecOrderId_result> callback) throws TException{
    PlatformArgs platformArgs = new PlatformArgs();
    platformArgs.setTimeoutMs(timeout);
    StackTraceElement callStackElement = Thread.currentThread().getStackTrace()[2];
    platformArgs.setSourceDesc(
  ...
  public long add_createExecOrderIdCall(AsyncCallRunner runner, int routeKey, int timeout, IMethodCallback<TradeHostingStorage.createExecOrderId_args, TradeHostingStorage.createExecOrderId_result> callback) throws TException{
    PlatformArgs platformArgs = new PlatformArgs();
    platformArgs.setTimeoutMs(timeout);
    StackTraceElement callStackElement = Thread.currentThread().getStackTrace()[2];
    platformArgs.setSourceDesc(
  ...
  protected TServiceCall create_createExecOrderIdServiceCall(int routeKey, int timeout, org.soldier.platform.svr_platform.comm.PlatformArgs platformArgs){
    ...
    serviceCall.setRouteKey(routeKey);
    serviceCall.setOneWay(false);
    TradeHostingStorage.createExecOrderId_args request = new TradeHostingStorage.createExecOrderId_args();
    request.setPlatformArgs(platformArgs);
    serviceCall.setRequest(request);
    serviceCall.setMethodName("createExecOrderId");
    serviceCall.setTimeout(timeout);
    serviceCall.setResponse(TradeHostingStorage.createExecOrderId_result.class);
    return serviceCall;
  }
  ...
  public long createExecTradeId(int routeKey, int timeout, IMethodCallback<TradeHostingStorage.createExecTradeId_args, TradeHostingStorage.createExecTradeId_result> callback) throws TException{
    PlatformArgs platformArgs = new PlatformArgs();
    platformArgs.setTimeoutMs(timeout);
    StackTraceElement callStackElement = Thread.currentThread().getStackTrace()[2];
    platformArgs.setSourceDesc(
  ...
  public long add_createExecTradeIdCall(AsyncCallRunner runner, int routeKey, int timeout, IMethodCallback<TradeHostingStorage.createExecTradeId_args, TradeHostingStorage.createExecTradeId_result> callback) throws TException{
    PlatformArgs platformArgs = new PlatformArgs();
    platformArgs.setTimeoutMs(timeout);
    StackTraceElement callStackElement = Thread.currentThread().getStackTrace()[2];
    platformArgs.setSourceDesc(
  ...
  protected TServiceCall create_createExecTradeIdServiceCall(int routeKey, int timeout, org.soldier.platform.svr_platform.comm.PlatformArgs platformArgs){
    ...
    serviceCall.setRouteKey(routeKey);
    serviceCall.setOneWay(false);
    TradeHostingStorage.createExecTradeId_args request = new TradeHostingStorage.createExecTradeId_args();
    request.setPlatformArgs(platformArgs);
    serviceCall.setRequest(request);
    serviceCall.setMethodName("createExecTradeId");
    serviceCall.setTimeout(timeout);
    serviceCall.setResponse(TradeHostingStorage.createExecTradeId_result.class);
    return serviceCall;
  }
  ...
  public long createExecTradeLegId(int routeKey, int timeout, IMethodCallback<TradeHostingStorage.createExecTradeLegId_args, TradeHostingStorage.createExecTradeLegId_result> callback) throws TException{
    PlatformArgs platformArgs = new PlatformArgs();
    platformArgs.setTimeoutMs(timeout);
    StackTraceElement callStackElement = Thread.currentThread().getStackTrace()[2];
    platformArgs.setSourceDesc(
  ...
  public long add_createExecTradeLegIdCall(AsyncCallRunner runner, int routeKey, int timeout, IMethodCallback<TradeHostingStorage.createExecTradeLegId_args, TradeHostingStorage.createExecTradeLegId_result> callback) throws TException{
    PlatformArgs platformArgs = new PlatformArgs();
    platformArgs.setTimeoutMs(timeout);
    StackTraceElement callStackElement = Thread.currentThread().getStackTrace()[2];
    platformArgs.setSourceDesc(
  ...
  protected TServiceCall create_createExecTradeLegIdServiceCall(int routeKey, int timeout, org.soldier.platform.svr_platform.comm.PlatformArgs platformArgs){
    ...
    serviceCall.setRouteKey(routeKey);
    serviceCall.setOneWay(false);
    TradeHostingStorage.createExecTradeLegId_args request = new TradeHostingStorage.createExecTradeLegId_args();
    request.setPlatformArgs(platformArgs);
    serviceCall.setRequest(request);
    serviceCall.setMethodName("createExecTradeLegId");
    serviceCall.setTimeout(timeout);
    serviceCall.setResponse(TradeHostingStorage.createExecTradeLegId_result.class);
    return serviceCall;
  }
  ...
  public long getRunningExecOrderIdByOrderRef(int routeKey, int timeout, xueqiao.trade.hosting.HostingExecOrderTradeAccountSummary accountSummary, xueqiao.trade.hosting.HostingExecOrderRef orderRef, IMethodCallback<TradeHostingStorage.getRunningExecOrderIdByOrderRef_args, TradeHostingStorage.getRunningExecOrderIdByOrderRef_result> callback) throws TException{
    PlatformArgs platformArgs = new PlatformArgs();
    platformArgs.setTimeoutMs(timeout);
    StackTraceElement callStackElement = Thread.currentThread().getStackTrace()[2];
    platformArgs.setSourceDesc(
  ...
  protected TServiceCall create_getRunningExecOrderIdByOrderRefServiceCall(int routeKey, int timeout, org.soldier.platform.svr_platform.comm.PlatformArgs platformArgs, xueqiao.trade.hosting.HostingExecOrderTradeAccountSummary accountSummary, xueqiao.trade.hosting.HostingExecOrderRef orderRef){
    ...
    serviceCall.setRouteKey(routeKey);
    serviceCall.setOneWay(false);
    TradeHostingStorage.getRunningExecOrderIdByOrderRef_args request = new TradeHostingStorage.getRunningExecOrderIdByOrderRef_args();
    request.setPlatformArgs(platformArgs);
    ...
    serviceCall.setTimeout(timeout);
    serviceCall.setResponse(TradeHostingStorage.getRunningExecOrderIdByOrderRef_result.class);
    return serviceCall;
  }
  ...
  protected TServiceCall create_getRunningExecOrderIdByOrderDealIDServiceCall(int routeKey, int timeout, org.soldier.platform.svr_platform.comm.PlatformArgs platformArgs, xueqiao.trade.hosting.HostingExecOrderTradeAccountSummary accountSummary, xueqiao.trade.hosting.HostingExecOrderDealID dealID){
    ...
    serviceCall.setRouteKey(routeKey);
    serviceCall.setOneWay(false);
    TradeHostingStorage.getRunningExecOrderIdByOrderDealID_args request = new TradeHostingStorage.getRunningExecOrderIdByOrderDealID_args();
    request.setPlatformArgs(platformArgs);
    request.setAccountSummary(accountSummary);
    ...
    serviceCall.setTimeout(timeout);
    serviceCall.setResponse(TradeHostingStorage.getRunningExecOrderIdByOrderDealID_result.class);
    return serviceCall;
  }
