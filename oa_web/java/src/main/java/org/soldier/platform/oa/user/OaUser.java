...
public class OaUser implements org.apache.thrift.TBase<OaUser, OaUser._Fields>, java.io.Serializable, Cloneable, Comparable<OaUser> {
  ...
  private static final int __LASTMOFIYTIMESTAMP_ISSET_ID = 2;
  private byte __isset_bitfield = 0;
  private _Fields optionals[] = {_Fields.USER_ID,_Fields.USER_NAME,_Fields.USER_PASSWORD,_Fields.USER_NICK_NAME,_Fields.CREATE_TIMESTAMP,_Fields.LASTMOFIY_TIMESTAMP};
