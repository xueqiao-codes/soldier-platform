...
public class DalSetUserList implements org.apache.thrift.TBase<DalSetUserList, DalSetUserList._Fields>, java.io.Serializable, Cloneable, Comparable<DalSetUserList> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("DalSetUserList");
  ...
  static {
    schemes.put(StandardScheme.class, new DalSetUserListStandardSchemeFactory());
    schemes.put(TupleScheme.class, new DalSetUserListTupleSchemeFactory());
  }

  public int totalNum; // required
  public List<DalSetUser> resultList; // required
  ...
  static {
    ...
    tmpMap.put(_Fields.RESULT_LIST, new org.apache.thrift.meta_data.FieldMetaData("resultList", org.apache.thrift.TFieldRequirementType.REQUIRED, 
        new org.apache.thrift.meta_data.ListMetaData(org.apache.thrift.protocol.TType.LIST, 
            new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, DalSetUser.class))));
    metaDataMap = Collections.unmodifiableMap(tmpMap);
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(DalSetUserList.class, metaDataMap);
  }

  public DalSetUserList() {
  }

  public DalSetUserList(
    int totalNum,
    List<DalSetUser> resultList)
  {
    this();
   ...
   */
  public DalSetUserList(DalSetUserList other) {
    __isset_bitfield = other.__isset_bitfield;
    this.totalNum = other.totalNum;
    if (other.isSetResultList()) {
      List<DalSetUser> __this__resultList = new ArrayList<DalSetUser>(other.resultList.size());
      for (DalSetUser other_element : other.resultList) {
        __this__resultList.add(new DalSetUser(other_element));
      }
      this.resultList = __this__resultList;
    }
  }

  public DalSetUserList deepCopy() {
    return new DalSetUserList(this);
  }
  ...
  public DalSetUserList setTotalNum(int totalNum) {
    this.totalNum = totalNum;
    setTotalNumIsSet(true);
    return this;
  }
  ...
  public java.util.Iterator<DalSetUser> getResultListIterator() {
    return (this.resultList == null) ? null : this.resultList.iterator();
  }

  public void addToResultList(DalSetUser elem) {
    if (this.resultList == null) {
      this.resultList = new ArrayList<DalSetUser>();
    }
    this.resultList.add(elem);
  }

  public List<DalSetUser> getResultList() {
    return this.resultList;
  }

  public DalSetUserList setResultList(List<DalSetUser> resultList) {
    this.resultList = resultList;
    return this;
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case RESULT_LIST:
      if (value == null) {
        ...
        setResultList((List<DalSetUser>)value);
      }
      break;
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof DalSetUserList)
      return this.equals((DalSetUserList)that);
    return false;
  }

  public boolean equals(DalSetUserList that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(DalSetUserList other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("DalSetUserList(");
    boolean first = true;
  ...
  private static class DalSetUserListStandardSchemeFactory implements SchemeFactory {
    public DalSetUserListStandardScheme getScheme() {
      return new DalSetUserListStandardScheme();
    }
  }

  private static class DalSetUserListStandardScheme extends StandardScheme<DalSetUserList> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, DalSetUserList struct) throws org.apache.thrift.TException {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.resultList = new ArrayList<DalSetUser>(_list16.size);
                for (int _i17 = 0; _i17 < _list16.size; ++_i17)
                {
                  DalSetUser _elem18;
                  _elem18 = new DalSetUser();
                  _elem18.read(iprot);
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, DalSetUserList struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.resultList != null) {
        oprot.writeFieldBegin(RESULT_LIST_FIELD_DESC);
        {
          ...
          for (DalSetUser _iter19 : struct.resultList)
          {
            _iter19.write(oprot);
          }
          oprot.writeListEnd();
  ...
  private static class DalSetUserListTupleSchemeFactory implements SchemeFactory {
    public DalSetUserListTupleScheme getScheme() {
      return new DalSetUserListTupleScheme();
    }
  }

  private static class DalSetUserListTupleScheme extends TupleScheme<DalSetUserList> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, DalSetUserList struct) throws org.apache.thrift.TException {
      TTupleProtocol oprot = (TTupleProtocol) prot;
      oprot.writeI32(struct.totalNum);
      {
        oprot.writeI32(struct.resultList.size());
        for (DalSetUser _iter20 : struct.resultList)
        {
          _iter20.write(oprot);
        }
      }
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, DalSetUserList struct) throws org.apache.thrift.TException {
      TTupleProtocol iprot = (TTupleProtocol) prot;
      struct.totalNum = iprot.readI32();
      struct.setTotalNumIsSet(true);
      {
        org.apache.thrift.protocol.TList _list21 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
        struct.resultList = new ArrayList<DalSetUser>(_list21.size);
        for (int _i22 = 0; _i22 < _list21.size; ++_i22)
        {
          DalSetUser _elem23;
          _elem23 = new DalSetUser();
          _elem23.read(iprot);
