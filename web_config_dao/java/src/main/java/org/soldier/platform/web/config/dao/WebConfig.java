            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.ipList = new ArrayList<Long>(_list0.size);
                for (int _i1 = 0; _i1 < _list0.size; ++_i1)
                {
                  long _elem2;
                  _elem2 = iprot.readI64();
                  struct.ipList.add(_elem2);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.domainList = new ArrayList<String>(_list3.size);
                for (int _i4 = 0; _i4 < _list3.size; ++_i4)
                {
                  String _elem5;
                  _elem5 = iprot.readString();
                  struct.domainList.add(_elem5);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.backendList = new ArrayList<String>(_list6.size);
                for (int _i7 = 0; _i7 < _list6.size; ++_i7)
                {
                  String _elem8;
                  _elem8 = iprot.readString();
                  struct.backendList.add(_elem8);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.domainList != null) {
        if (struct.isSetDomainList()) {
          oprot.writeFieldBegin(DOMAIN_LIST_FIELD_DESC);
          {
            ...
            for (String _iter10 : struct.domainList)
            {
      ...
      if (struct.backendList != null) {
        if (struct.isSetBackendList()) {
          oprot.writeFieldBegin(BACKEND_LIST_FIELD_DESC);
          {
            ...
            for (String _iter11 : struct.backendList)
            {
      ...
      if (struct.isSetIpList()) {
        {
          ...
          for (long _iter12 : struct.ipList)
          {
      ...
      if (struct.isSetDomainList()) {
        {
          ...
          for (String _iter13 : struct.domainList)
          {
      ...
      if (struct.isSetBackendList()) {
        {
          ...
          for (String _iter14 : struct.backendList)
          {
      ...
      if (incoming.get(2)) {
        {
          ...
          struct.ipList = new ArrayList<Long>(_list15.size);
          for (int _i16 = 0; _i16 < _list15.size; ++_i16)
          {
            long _elem17;
            _elem17 = iprot.readI64();
            struct.ipList.add(_elem17);
          }
        }
        struct.setIpListIsSet(true);
      }
      ...
      if (incoming.get(4)) {
        {
          ...
          struct.domainList = new ArrayList<String>(_list18.size);
          for (int _i19 = 0; _i19 < _list18.size; ++_i19)
          {
            String _elem20;
            _elem20 = iprot.readString();
            struct.domainList.add(_elem20);
          }
        }
        struct.setDomainListIsSet(true);
      }
      ...
      if (incoming.get(9)) {
        {
          ...
          struct.backendList = new ArrayList<String>(_list21.size);
          for (int _i22 = 0; _i22 < _list21.size; ++_i22)
          {
            String _elem23;
            _elem23 = iprot.readString();
            struct.backendList.add(_elem23);
          }
        }
        struct.setBackendListIsSet(true);
      }
