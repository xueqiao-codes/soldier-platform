...
typedef void (*HashTblRemoveCallback)(qhasharr_t* tbl, const std::string& removeKey, bool remove_success);
extern HashTblRemoveCallback global_hash_tbl_remove_callback;
