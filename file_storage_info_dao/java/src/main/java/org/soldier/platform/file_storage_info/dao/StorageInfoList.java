...
public class StorageInfoList implements org.apache.thrift.TBase<StorageInfoList, StorageInfoList._Fields>, java.io.Serializable, Cloneable, Comparable<StorageInfoList> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("StorageInfoList");
  ...
  static {
    schemes.put(StandardScheme.class, new StorageInfoListStandardSchemeFactory());
    schemes.put(TupleScheme.class, new StorageInfoListTupleSchemeFactory());
  }

  public int totalNum; // required
  public List<StorageInfo> resultList; // required
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(StorageInfoList.class, metaDataMap);
  }
   ...
   */
  public StorageInfoList(StorageInfoList other) {
    __isset_bitfield = other.__isset_bitfield;
    this.totalNum = other.totalNum;
    if (other.isSetResultList()) {
      List<StorageInfo> __this__resultList = new ArrayList<StorageInfo>(other.resultList.size());
      for (StorageInfo other_element : other.resultList) {
        __this__resultList.add(new StorageInfo(other_element));
      }
      this.resultList = __this__resultList;
    }
  }

  public StorageInfoList deepCopy() {
  ...
  public StorageInfoList setTotalNum(int totalNum) {
    this.totalNum = totalNum;
    setTotalNumIsSet(true);
    return this;
  }
  ...
  public java.util.Iterator<StorageInfo> getResultListIterator() {
    return (this.resultList == null) ? null : this.resultList.iterator();
  }

  public void addToResultList(StorageInfo elem) {
    if (this.resultList == null) {
      this.resultList = new ArrayList<StorageInfo>();
    }
    this.resultList.add(elem);
  }

  public List<StorageInfo> getResultList() {
    return this.resultList;
  }

  public StorageInfoList setResultList(List<StorageInfo> resultList) {
    this.resultList = resultList;
    return this;
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case RESULT_LIST:
      if (value == null) {
        ...
        setResultList((List<StorageInfo>)value);
      }
      break;
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof StorageInfoList)
      return this.equals((StorageInfoList)that);
    return false;
  }

  public boolean equals(StorageInfoList that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(StorageInfoList other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("StorageInfoList(");
    boolean first = true;
  ...
  private static class StorageInfoListStandardSchemeFactory implements SchemeFactory {
    public StorageInfoListStandardScheme getScheme() {
      return new StorageInfoListStandardScheme();
    }
  }

  private static class StorageInfoListStandardScheme extends StandardScheme<StorageInfoList> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, StorageInfoList struct) throws org.apache.thrift.TException {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.resultList = new ArrayList<StorageInfo>(_list0.size);
                for (int _i1 = 0; _i1 < _list0.size; ++_i1)
                {
                  StorageInfo _elem2;
                  _elem2 = new StorageInfo();
                  _elem2.read(iprot);
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, StorageInfoList struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.resultList != null) {
        oprot.writeFieldBegin(RESULT_LIST_FIELD_DESC);
        {
          ...
          for (StorageInfo _iter3 : struct.resultList)
          {
            _iter3.write(oprot);
          }
          oprot.writeListEnd();
  ...
  private static class StorageInfoListTupleSchemeFactory implements SchemeFactory {
    public StorageInfoListTupleScheme getScheme() {
      return new StorageInfoListTupleScheme();
    }
  }

  private static class StorageInfoListTupleScheme extends TupleScheme<StorageInfoList> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, StorageInfoList struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetResultList()) {
        {
          ...
          for (StorageInfo _iter4 : struct.resultList)
          {
            _iter4.write(oprot);
          }
        }
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, StorageInfoList struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.resultList = new ArrayList<StorageInfo>(_list5.size);
          for (int _i6 = 0; _i6 < _list5.size; ++_i6)
          {
            StorageInfo _elem7;
            _elem7 = new StorageInfo();
            _elem7.read(iprot);
